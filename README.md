## Notes from some papers I've read: 
1. [SSD: Single Shot MultiBox Detector](https://github.com/wildOsprey/papers_notes/blob/master/ssd.md)
2. [FaceNet: A Unified Embedding for Face Recognition and Clustering](https://github.com/wildOsprey/papers_notes/blob/master/facenet.md)
3. [How far are we from solving the 2D&3D Face Alignment problem? (and a dataset of 230,000 3D facial landmarks)](https://github.com/wildOsprey/papers_notes/blob/master/fan.md)
